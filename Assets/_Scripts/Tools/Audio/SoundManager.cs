...
namespace MineSweeperRipeoff
{
    public class SoundManager : MonoBehaviour
    {
        ...
        [SerializeField] SoundAudioClipPair[] soundAudioClipDuosArray;
        ...
        public void PlaySound3D(ClipName clipName, Vector3 position, float pitch = 1)
        {
            //GameObject soundGameObject = new GameObject("Sound");
            //AudioSource audioSource = soundGameObject.AddComponent<AudioSource>();
            AudioSource audioSource = _sfxAudioSourceQueue.Dequeue();
        ...
        {
            foreach (SoundAudioClipPair soundAudioClip in soundAudioClipDuosArray)
            {
