...
namespace MineSweeperRipeoff
{
    public class FieldCell : MonoBehaviour, IPointerClickHandler
    {
        ...
        protected virtual void Event_UpdateCellContent(int sequenceCount)
        {
            ...
            if (referencedCell.cellType != CellType.Mine)
            {
                GameplayManager.Instance.RequestClearParticle(this);
            ...
            {
                GameplayManager.Instance.RequestBombParticle(this);
        ...
        private void TryRevealCell()
        {
            ...
            GameplayManager.Instance.ReavealCell(referencedCell.coordinates);
        }
        ...
        private void TryFlagCell()
        {
            ...
            //SoundManager.Instance.PlaySound(ClipName.TileClicked);
            GameplayManager.Instance.UpdateCellFlagState(referencedCell.coordinates);
        }
        ...
        public virtual void OnPointerClick(PointerEventData eventData)
        {
            ...
            {
                if (GameplayManager.Instance.CurrentMoveType == MoveType.Clear)
                {
                    if (referencedCell.isFlagged) return;
                    TryRevealCell();
                }
