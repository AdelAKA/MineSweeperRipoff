...
namespace MineSweeperRipeoff
{
    ...
    public class OptimizedGridSolver : Grid
    {
        ...
        public OptimizedGridSolver(float delay = 0) : base()
        {
            this._delay = delay;
        ...
        public OptimizedGridSolver(Vector2Int? gridSizeTarget, int? numberOfMinesTarget, GameMode gameMode, bool isSpeedRunMode = true, float delay = 0) : base(gridSizeTarget, numberOfMinesTarget, gameMode, isSpeedRunMode)
        {
            this._delay = delay;
        }
